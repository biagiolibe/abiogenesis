...
# ---------- 1. AMBIENT DRONE: three environmental states ----------
...
write_wav('01-drone-cold-dark.wav',  drone(12, 55, warmth=0.1, instability=0.05, openness=0.15))
write_wav('02-drone-warm-bright.wav',drone(12, 82, warmth=0.8, instability=0.05, openness=0.9))
write_wav('03-drone-toxic.wav',      drone(12, 62, warmth=0.4, instability=0.85, openness=0.35))
