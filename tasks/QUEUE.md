...
| `READY_FOR_REVIEW` | 191 | "How to play" presentation: chrome, bullets, responsive height, width containment, hanging indent, bold lead-terms — all three amendments live-check confirmed by user 2026-09-02. **Process note**: implemented directly on `main` across all passes, not on a `task/191-...` branch — `docs/BRANCHING_POLICY.md` landed mid-task; see task file's own note before reviewing | `VISUAL_STYLE_GUIDE.md` §2/§6 — [191](191-how-to-play-presentation.md) |
