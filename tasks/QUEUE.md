...
| `ACCEPTED` | 191 | "How to play" presentation: chrome, bullets, responsive height, width containment, hanging indent, bold lead-terms — all three amendments live-check confirmed by user 2026-09-02. Reviewed and accepted directly on `main` (grandfathered pre-`docs/BRANCHING_POLICY.md`, same as task 190) | `VISUAL_STYLE_GUIDE.md` §2/§6 — [191](191-how-to-play-presentation.md) |
