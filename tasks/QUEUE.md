...
| `[/]` | 094 | On-screen buttons for tick/era/notebook controls — code done, pending user's live `cargo run` verification | 030 | [094](094-hud-buttons-for-tick-era-notebook-controls.md) |
